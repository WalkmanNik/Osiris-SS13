...
/mob/living/simple_animal/borer/proc/update_borer_level()
	...
	if((borer_exp >= 80) && (borer_level < 3))
		...
		to_chat(src, SPAN_NOTICE("Congratulation! You reached Evolution Level 3, new syntesis reagents and new abilitie is now availeble."))
		max_chemicals += (borer_level * 10)
		max_chemicals_inhost = max_chemicals * 5
	...
	if((borer_exp >= 160) && (borer_level < 4))
		...
		maxHealth = 100
		speed = 1
		to_chat(src, SPAN_NOTICE("Congratulation! You reached Evolution Level 4, new syntesis reagents and new abilitie is now availeble."))
		max_chemicals += (borer_level * 10)
		max_chemicals_inhost = max_chemicals * 5
	...
	if((borer_exp >= 320) && (borer_level < 5))
		...
		to_chat(src, SPAN_NOTICE("Congratulation! You reached Evolution Level 5, new syntesis reagents and new abilitie is now availeble."))
		max_chemicals += (borer_level * 10)
		max_chemicals_inhost = max_chemicals * 5
